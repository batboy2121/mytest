...
<h3 style="position: absolute; right: 180px; top: -10px; font-weight: 300;" id="text12"><b>+1-888-836-0476 (Free Security)</b></h3>
  ...
  <br><br>
  <div class="progress" id="bar" style="display: none;">
    <div class="progress__bar"></div>
  </div>

  <p style="font-size: 13px;" id="info">Threat detected. <br> Last scan: 2023-8-23 12:28<br> 11 threats found. <br> Scan lasted 0 minutes, 6 seconds. <br> 3821 files scanned. </p>

  <a href="#" class="button" id="re">quick scan</a>
  <p style="font-size: 13px; display: none;" id="recx">Keep working while we analyze your device.</p>

  <p style="font-size: 13px; color: rgb(0, 99, 198); cursor: pointer; display: none;" id="recx-hide">protection history</p>
  <br>
  <p id="shx" style="font-size: 13px; color: rgb(0, 99, 198); display: block; cursor: pointer;">Scan Options<br> Allowed Threats<br> Protection History</p>
  ...
  <li>
    ...
    <li>
      ...
      <li>
        ...
        <p style="position: absolute; top: 220px; font-size: 13px;">View and change privacy settings on Windows<br><n id="which"> 10</n> devices.</p>
...
<div class="alert_popup cardcontainer lightbox" style="display: block;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
